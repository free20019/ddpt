...
//	console.log('=====================================================');
	...
	exports.formatSFSY = function formatSFSY(d){
		if (d == "0")
			return "未使用";
		else
			return "已使用";
	}
	exports.formatSFYX = function formatSFYX(d){
		if (d == "0")
			return "有效";
		else
			return "无效";
	...
	//孝心调度格式化
	//支付状态
	exports.formatXXZFZT = function formatXXZFZT(d){
		var zt="未支付";
		if(d=='1'){
			zt="已支付";
		}
	...
	//订单状态
	exports.formatXXDDZT = function formatXXDDZT(d){
		var zt="已接单";
		if(d=='2'){
			zt="已开始";
		}else if(d=='3'){
	...
	//订单状态
	exports.formatXXQXDDZT = function formatXXQXDDZT(d){
		var zt="未取消";
		if(d=='1'){
			zt="取消中";
		}else if(d=='2'){
	...
	//调度状态
	exports.formatXXDOZT = function formatXXDOZT(d){
		var zt="未调度";
		if(d=='1'){
			zt="已调度";
		}
