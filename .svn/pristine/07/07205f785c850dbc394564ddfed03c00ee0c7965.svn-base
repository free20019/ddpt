define([ "dijit/Dialog", "dgrid/Editor", "dijit/form/Button",
	...
	function(Dialog, Editor, Button, DateTextBox, TimeTextBox,
		...
		$("#clsxltj-startTime").val(setformatday(new Date));
		$("#clsxltj-endTime").val(setformatday(new Date));
		var postData = {"stime":$("#clsxltj-startTime").val(),"etime":$("#clsxltj-endTime").val(),"comp":$("#clsxltj-comp").val()};
		var xhrArgs = {
