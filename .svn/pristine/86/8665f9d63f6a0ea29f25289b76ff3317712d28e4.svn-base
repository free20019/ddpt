...
public class DataItem{
	...
	public List<Vehicle> getAxvehilist() {
		return axvehilist;
	}

	public void setAxvehilist(List<Vehicle> axvehilist) {
		this.axvehilist = axvehilist;
	}

	public Numb getAxnum() {
		return axnum;
	}

	public void setAxnum(Numb axnum) {
		this.axnum = axnum;
	}
}