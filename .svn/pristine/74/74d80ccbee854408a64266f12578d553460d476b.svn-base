...
//              System.out.println((String)map.get("isu")+"  "+map.get("emptyOrHeavy"));
                ...
                vehilist.add(va);
                boolean sfax=false;
                if(lovevehilist.indexOf(va.getVehino())>-1){
                	axtotal++;
                	sfax=true;
				}
            ...
            num.setNnum(nnum + "");
			num.setDrsxs(drsxs+"");
            axnum.setTotal(axtotal + "");
            axnum.setOnnum(axonnum + "");
            axnum.setOffnum(axoffnum + "");
            axnum.setHnum(axhnum + "");
            axnum.setNnum(axnnum + "");
...
//          GisData.map.clear();
            ...
            data.setLovelist(lovevehilist);
            data.setAxvehilist(axvehilist);
...
//                doBusiness();
    ...
    public boolean todayLine(String date1){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd");
        try {
            Date start = sdf.parse(date1);
            Date end = new Date();
            String startday = sdf1.format(start);
            String endday = sdf1.format(end);
