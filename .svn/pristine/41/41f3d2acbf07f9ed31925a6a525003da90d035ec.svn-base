...
public class ZhywAction {
	...
	public String jybg_daochu(HttpServletRequest request,
		...
		String a[] = {"营运类型","区域","公司","车牌号码","终端编号","营运资格服务证","上车时间","下车时间","计程(公里)","等候时间","交易金额","空驶(公里)","接收时间"};//导出列明
	...
	public String clskjy_daochu(HttpServletRequest request,
		...
		String a[] = {"营运类型","区域","公司","车牌号码","终端编号","营运资格服务证","上车时间","下车时间","计程(公里)","等候时间","交易金额","空驶(公里)","接收时间","卡原额","城市代码","唯一代码","卡留水号","保留位","终端交易流水号","交易类型","卡类型","钱包累计交易次数","启用时间","存钱时间","TAC交易认证码","POS机号","企业编号"};//导出列明
	...
	public String clyyjy_daochu(HttpServletRequest request,
		...
		String a[] = {"营运类型","区域","公司","车牌号码","终端类型","终端编号","营运资格服务证","上车时间","下车时间","计程(公里)","等候时间","交易金额","空驶(公里)","接收时间","卡原额","城市代码","唯一代码","卡留水号","保留位","终端交易流水号","交易类型","卡类型","钱包累计交易次数","启用时间","存钱时间","TAC交易认证码","POS机号","企业编号"};//导出列明
...
//---------------------------------------------------------//
	...
	public String jysjhz_daochu(HttpServletRequest request,
		...
		String a[] = {"区域","公司名称","车牌号码","交易次数","交易金额","交易计程(公里)","交易空驶(公里)","交易等待时间(分钟)","交易营运时间(分钟)"};//导出列明
