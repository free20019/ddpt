...
//		Sender.StartSend("192.168.0.102","hz_quxiaoyueche_02",postData);
	 ...
	 * 查询投诉模板
	 */
	@RequestMapping(value = "/findTsmb")
	@ResponseBody
	public String findTsmb() throws IOException {
		String msg = ddxptService.findTsmb();
		return msg;
	}
	@RequestMapping(value = "/addTsmb")
	@ResponseBody
	public String addTsmb(@RequestParam String postData) throws IOException {
		String msg = ddxptService.addTsmb(postData);
		return msg;
	}

	@RequestMapping(value = "/delTsmb")
	@ResponseBody
	public String delTsmb(@RequestParam String tsmbid) throws IOException {
		String msg = ddxptService.delTsmb(tsmbid);
		return msg;
	}
	...
	public String jybg_daochu(HttpServletRequest request,
		...
		String a[] = {"业务编号","来电号码","姓名","处理状态","处理时间","处理类型","投诉类型","工号","车牌号码","服务内容","处理对象","公司名称"};//导出列明
		String b[] = {"CS_ID","CS_TELNUM","CS_CLIENT","CS_STATE","CS_DEALDATETIME","CS_TYPE","CS_TSLX","CS_WORKERNUM","CS_VEHIID","CS_MEMO","CS_OBJECT","COMPANY"};//导出map中的key
...
//		System.out.println(cp);
	...
	//爱心空车
	@RequestMapping(value = "/queryaxddorder")
	@ResponseBody
	public String queryaxddorder(HttpServletRequest request,@RequestParam("postData") String postData
			) {
		String msg = ddxptService.queryaxddorder(postData);
		return msg;
	}
	@RequestMapping(value = "/qxaxddorder")
	@ResponseBody
	public String qxaxddorder(HttpServletRequest request,@RequestParam("postData") String postData
			)throws IOException {
		postData = java.net.URLDecoder.decode(postData, "UTF-8");
		String msg = ddxptService.qxaxddorder(postData);
		return msg;
	}
	@RequestMapping(value = "/editaxddorder")
	@ResponseBody
	public String editaxddorder(HttpServletRequest request,@RequestParam("postData") String postData
			)throws IOException {
		postData = java.net.URLDecoder.decode(postData, "UTF-8");
		String msg = ddxptService.editaxddorder(postData);
		return msg;
	}
	@RequestMapping(value = "/delaxddorder")
	@ResponseBody
	public String delaxddorder(HttpServletRequest request,@RequestParam("postData") String postData
			) {
		String msg = ddxptService.delaxddorder(postData);
		return msg;
	}
	@RequestMapping(value = "/pjaxddorder")
	@ResponseBody
	public String pjaxddorder(HttpServletRequest request,@RequestParam("postData") String postData
			) throws IOException {
		postData = java.net.URLDecoder.decode(postData, "UTF-8");
		String msg = ddxptService.pjaxddorder(postData);
		return msg;
	}

	@RequestMapping(value = "/axkcdata")
	@ResponseBody
	public String axkcdata(HttpServletRequest request,@RequestParam("postData") String postData
			) throws IOException {
		String msg = ddxptService.axkcdata();
		return msg;
	}
	@RequestMapping(value = "/queryCompByVehino")
	@ResponseBody
	public String queryCompByVehino(HttpServletRequest request,@RequestParam("cp") String cp
			) throws IOException {
		String msg = ddxptService.queryCompByVehino(cp);
		return msg;
	}
	@RequestMapping(value = "/axdd")
	@ResponseBody
	public String axdd(HttpServletRequest request,@RequestParam("postData") String postData
			) throws IOException {
		postData = java.net.URLDecoder.decode(postData, "UTF-8");
		String msg = ddxptService.axdd(postData);
		return msg;
	}
